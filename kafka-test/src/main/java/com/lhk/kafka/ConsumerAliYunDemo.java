...
public class ConsumerAliYunDemo {
    public static void main(String[] args) {
        ...
        props.put(SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG, "C:/tmp/kafka.client.truststore.jks");
        //根证书store的密码，保持不变
        ...
        //属于同一个组的消费实例，会负载消费消息
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "9b10ba1d-a563-4877-a29d-d3089bdffa01-sq");
        //构造消息对象，也即生成一个消费实例
