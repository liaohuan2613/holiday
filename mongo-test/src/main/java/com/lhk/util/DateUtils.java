...
//	public static Date offsetDayByYear(Date aDay, int days) {
//		GregorianCalendar oneCalendar = new GregorianCalendar();
//		oneCalendar.setTime(aDay);
//		oneCalendar.add(Calendar.DAY_OF_YEAR, days);
//
//		return oneCalendar.getTime();
//
//	}
	...
	public static void main(String[] args) {
		...
		// Date date = new Date();
		//
		// System.out.println(sdf.format(DateUtils.toUTCDate(date)));
		//
		// System.out.println(sdf.format(DateUtils.toUTCDate(DateUtils.offsetMinutes(date,
		// 15))));

		// System.out.println(sdf.format(DateUtils.nowUTC()));
		// System.out.println(sdf.format(DateUtils.getStartOfDate(DateUtils.offsetDay(DateUtils.nowUTC(),
		// -30))));
		// System.out.println(sdf.format(DateUtils.getStartOfDate(DateUtils.nowUTC())));

		System.out.println(DateUtils.hourIn24Hours(DateUtils.nowUTC()));

		System.out.println(DateUtils.minutesIn60Minutes(DateUtils.nowUTC()));

		System.out.println(DateUtils.diffDays(DateUtils.nowUTC(), DateUtils.offsetDay(DateUtils.nowUTC(), 1)));
	}
